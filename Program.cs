    ...
    switch (userMenuSelection)
    {
        ...
        case 5: // Random Mode
            ...
            while (numberOfQuestions > 0)
            {
                ...
                firstNumber = random.Next(1, 101);
                secondNumber = random.Next(1, 101);
                char operation = randomOperation switch
                {
                    1 => '+',
                    2 => '-',
                    3 => '*',
                ...
                score += await PerformOperation(mathGame, firstNumber, secondNumber, score, operation, difficultyLevel);
                numberOfQuestions--;
            }
            break;
        case 6: // Show Game History
